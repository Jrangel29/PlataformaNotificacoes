...
function NotificationTimeSelection(props) {
  return (
    <div className="row m-0 mt-2">
        <div className='btn btnSeccao' onClick={() => props.mudaColapsado(4)}>
            <h1 className="tituloSeccaoPaginaNotifs">Envio de notificação</h1>
                ...
                <span className="col-2">
                    <Dropdown>
                        <Dropdown.Toggle variant="flat" className="dropdownFiltro">
                            {props.parametros.envioNotif}
                        </Dropdown.Toggle>

                        <Dropdown.Menu className="dropdownFiltro">
                            <Dropdown.Item onClick={() => props.alterarEnvio("Envio Único")}>
                                Envio Único
                            </Dropdown.Item>
