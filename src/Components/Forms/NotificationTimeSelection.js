            ...
            : 
                ...
                <div className='mt-3'>
                    ...
                    <span className="col-3">
                        ...
                        <p className='bigSmallSmall mb-1'>A data é preenchida no formato MM-DD-AAAA, mas no resto da plataforma aparece como DD-MM-AAAA. Esta não pode ser anterior à data do dia atual.</p>
                        <span className="row col-12">
                            <span className="col-3">
