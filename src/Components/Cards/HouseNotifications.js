...
const HouseNotifications = (props) => {
    ...
    return(            
        <div className='container m-0'>
            <div className='row cartasMainBody'>
                {props.info.length !== 0 && props.info.map((val, key) => {
                    return(
                    val.map((item, index) => {
                        ...
                        if(props.seccao === 'Por Enviar'){
                            ...
                            if(index + 1 === props.info.length && contagemFuture === 0){
                                return(
                            ...
                            if(index + 1 === props.info.length && contagemPast === 0){
                                return(
                                    <span key={index} className='col-12 ps-0 pb-3' style={{textAlign:'center'}}>
