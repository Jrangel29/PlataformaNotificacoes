        ...
        <div className='container m-0'>
            <div className='row cartasMainBody'>
                {props.notificacoes.length !== 0 && sorted.map((item, index) => {
                    ...
                    var dataFinal = ((dataNova.getMonth() > 8) ? (dataNova.getMonth() + 1) : ('0' + (dataNova.getMonth() + 1))) + '/' + ((dataNova.getDate() + 1 > 9) ? dataNova.getDate() + 1 : ('0' + (dataNova.getDate() + 1)))  + '/' + dataNova.getFullYear();
