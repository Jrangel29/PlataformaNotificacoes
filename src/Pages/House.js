        ...
        <div>
          ...
          <div className="mx-3" style={{ padding: "10px 40px" }}>
            <p className="textoSeccaoPagina">
              <b>Nome:</b> {casaInfo.nome}
            </p>
            <p className="textoSeccaoPagina">
              <b>Localidade:</b> {casaInfo.localidade}
            </p>
            <p className="textoSeccaoPagina">
        ...
        <div className="p-0 m-0 mt-3">
          ...
          <div className="mt-1 mx-3" style={{ padding: "0 40px" }}>
            <div className="row offset-1 mt-4 col-10 justify-content-center">
              <Button
                onClick={() => setSeccao("Por Enviar")}
                className="seccaoBtn col-3 mx-2"
                variant={seccao == "Por Enviar" ? "flat" : "custom"}
              >
                Por Enviar
              </Button>
              <Button
                onClick={() => setSeccao("Enviadas")}
                className="seccaoBtn col-3 mx-2"
                variant={seccao == "Enviadas" ? "flat" : "custom"}
              >
                Enviadas
              </Button>
            </div>
