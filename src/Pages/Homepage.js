      ...
      <div className='mainHomepage'>
        <div className='conteudoHomepage container'>
          <div className='fila row'>
            <Link to='/events/create' className='quadradoAzul col-sm-4 col-lg-3'>
              <img src={lapis} className='imagemHomepage' />
              <>Criar eventos</>
            </Link>
            <Link to='/events' className='quadradoAzul col-sm-4 col-lg-3'>
              <img src={event} className='imagemHomepage' />
              <>Eventos criados</>
            </Link>
            <Link to='/notifications' className='quadradoAzul col-sm-4 col-lg-3'>
              <img src={sino} className='imagemHomepage' />
              <>Notificações por enviar</>
            </Link>
            <Link to='/history' className='quadradoAzul col-sm-4 col-lg-3'>
              <img src={historico} className='imagemHomepage' />
              <>Notificações enviadas</>
            </Link>
            <Link to='/users' className='quadradoAzul col-sm-4 col-lg-3'>
              <img src={pessoas} className='imagemHomepage' />
              <>Utilizadores</>
            </Link>
            <Link to='/houses' className='quadradoAzul col-sm-4 col-lg-3'>
